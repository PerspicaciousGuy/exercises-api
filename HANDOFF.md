...
Start Phase 6 provider-neutral billing and developer account flow when ready: choose the first billing provider, likely Razorpay for India-first subscriptions or Lemon Squeezy for global merchant-of-record style checkout; add provider-neutral billing fields; implement checkout creation, verified webhooks, subscription-tier updates, safe downgrade behavior, and billing documentation. Phase 7 developer experience docs are still pending after billing.
